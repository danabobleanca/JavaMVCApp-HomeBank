	...
	<div id="container">
		...
		<section id="welcome">
			...
			<div id="welcome_box2">
				...
				<form action="/HomeBank/paymentProcessed" method="post">
					...
					<div id="payments_accounts">
						...
						<div id="from_account">
							...
							<select id="ibanPayment" name="ibanPayment">
								...
								<option title="Current account">${ibanSavings} </option>
						...
						<div id="to_account">
						<h5>Where do you want to send the money?</h5>
							<select id="otherIban" name="otherIban">
							
								<option  title="Savings account">${ibanSavings} </option>
								<option  title="Savings account">${iban} </option>
							</select>
							<br/><br/><br/><h5>Payment details</h5>
